...
procedure TForm5.EdBuscarChange(Sender: TObject);
begin
  Disciplinas.Buscar(EdBuscar.Text);
end;
...
procedure TForm5.ListaKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
